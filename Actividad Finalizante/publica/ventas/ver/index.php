...
printf( "<p><strong>%s</strong>: <mark>%s</mark></p>", "idCliente", $encontrado->idCliente );
printf( "<p><strong>%s</strong>: <mark>%s</mark></p>", "IdProducto", $encontrado->IdProducto );
printf( "<p><strong>%s</strong>: <mark>%s</mark></p>", "cantidadProductos", $encontrado->cantidadProductos );
printf( "<p><strong>%s</strong>: <mark>%s</mark></p>", "modoPago", $encontrado->modoPago );
