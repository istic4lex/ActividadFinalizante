...
printf( "<p><strong>%s</strong>: <mark>%s</mark></p>", "Nombre del cliente", $encontrado->nombreCliente );
printf( "<p><strong>%s</strong>: <mark>%s</mark></p>", "Apellido del cliente", $encontrado->apellidoCliente );
printf( "<p><strong>%s</strong>: <mark>%s</mark></p>", "Teléfono", $encontrado->telefono );
printf( "<p><strong>%s</strong>: <mark>%s</mark></p>", "Correo electrónico", $encontrado->direccion );
printf( "<p><strong>%s</strong>: <mark>%s</mark></p>", "Fecha de alta", $encontrado->fechaAlta );
