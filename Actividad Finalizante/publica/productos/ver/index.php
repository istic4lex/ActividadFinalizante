<?php
    ...
    TProductos.marca,
    TProductos.precio,
    TCategorias.nombreCategoria,
    TProductos.descripcion,
    TProductos.foto
...
INNER JOIN
    TCategorias
    ON TProductos.categoria=TCategorias.id

WHERE TProductos.id='$id'    
;";
...
?>
    ...
    <p><strong>Categoría:</strong> <?= $encontrado->nombreCategoria ?></p>
